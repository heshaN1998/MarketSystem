...
public class OrderForm extends javax.swing.JFrame {
    ...
    private OrderController orderController = new OrderController(); 
      ...
      public ArrayList<OrderDetailDto> orderDetailDto = new ArrayList<>();
    /**
    ...
    private void searchItem() {
        try {
            itemDto iitemDto = itemController.searchItem(txtItemCode.getText());
           if(iitemDto != null) {
               lblItemData.setText(iitemDto.getDesc() + " | " + iitemDto.getPack() + " | " + iitemDto.getQoh() + " | " + iitemDto.getUnitPrize() );
           }else{
...
orderDetailDto.setItemCode(txtItemCode.getText());
    ...
    this.orderDetailDto.add(orderDetailDto);
    
    Object[] rowData = {orderDetailDto.getItemCode(), orderDetailDto.getQty(),
    ...
    private void placeOrder(){
        ...
        orderDto.setOrderData(curDateStr);
        
        
        try {
            String resp = orderController.placeOrder(orderDto, orderDetailDto);
